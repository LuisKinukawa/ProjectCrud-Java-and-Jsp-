...
<br>
<h2 style="font-weight:600;font-family:Tahoma;text-align:center;">Cadastro de dieta</h2>
<br>
<br>
<div class="imagem">
	<img src="Health_track8.jpg" style="height:350px;width:500px;display:table-cell;float:left; position:relative;margin-left:50px">
</div>
...
<div class="container" >
		...
		<br>
		<form action="addcaloria.jsp" method="post">
		  <div class="mb-3">
		    <label for="pComida" class="form-label" style= "width:300px;">Comida: </label>
		    <input name="comida" type="text" class="form-control" id="pComida" aria-describedby="emailHelp" style= "width:350px;" required>
		    
		  </div>
		  <div class="mb-3">
		    <label for="pCaloria" class="form-label" style= "width:300px;">Caloria: </label>
		    <input name="caloria" type="text" class="form-control" id="pCaloria" aria-describedby="emailHelp" style= "width:350px;" required>
