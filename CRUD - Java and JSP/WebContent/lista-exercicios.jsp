...
<%@ page import="br.com.fiap.model.Atividade" %>
...
<br>
<h2 style="font-weight:600;font-family:Tahoma;text-align:center;">Atividades</h2>


	<br>
	<br>
<div class="imagem">
	<img src="Health_track5.jpg" style="height:500px;width:700px;position:relative;margin-left:270px">
</div>
	
<br>
<br>

<h4 class="col-6" style="font-weight:600;font-family:Tahoma;">Lista de atividades</h4>
	
	<%
	List<Atividade> list = AtividadeDAO.getAllAtividade();
	request.setAttribute("list", list);
	%>
<br>
<br>
<table  class="table" style="border:3px solid #3680bd;position:relative;width:800px;margin-left:350px">
  <thead  style="background-color: #3680bd;">
    <tr>
      <th scope="col" style="color:white;">Atividade</th>
      <th scope="col" style="color:white;">Tempo em minutos</th>
      ...
      <th scope="col" style="color:white;">Deletar</th>
		...
		<c:forEach items="${list}" var="atividade">
			...
			<td><a type="button" class="btn btn-outline-primary" style="color:black;"
				href="editformatv.jsp?data=${atividade.getData() }">Editar</a></td>
			<td><a type="button" class="btn btn-outline-primary" style="color:black;"
				href="deleteatv.jsp?data=${atividade.getData()}"><i class="fa fa-trash"></i></a></td>
			</tr>
		</c:forEach>
		
	</table>

<a type="button" href="cadastro-novo-atv.jsp" class="btn btn-outline-primary" style="position:absolute;margin-left:410px;">Novo cadastro</a>
<br>
<br>
<br>
<br>
