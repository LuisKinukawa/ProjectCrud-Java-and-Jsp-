...
<body>
	...
	<%
		...
		Atividade atividade = AtividadeDAO.getRegistrobyData(data);
	%>
...
<br>
<h2 style="font-weight:600;font-family:Tahoma;text-align:center;">Editar atividade</h2>
...
<br>
	...
	<form action="editAtv.jsp" method="post">
				<h4 style="font-weight:600;font-family:Tahoma;text-align:center;"><%=atividade.getData()%></h4>
		
			<table class="table" style="border:3px solid #3680bd;position:relative;width:800px;margin-left:250px">
				<tr>
					<td>Nome Atividade</td>
					<td><input type="text" name="nome" value="<%=atividade.getNome()%>"/></td>
				</tr>
				<tr>
					<td>Tempo</td>
					<td><input type="text" name="tempo" value="<%=atividade.getTempo()%>"/></td>
				</tr>
				<tr>
					<td>Data</td>
					<td><input type="text" name="data" value="<%=atividade.getData()%>"/></td>
				</tr>
