...
<body>
	...
	<%
		...
		Peso peso = PesoDAO.getRegistrobyData(data);
	%>
...
<br>
	...
	<form action="editpeso.jsp" method="post">
			<h4 style="font-weight:600;font-family:Tahoma;text-align:center;"><%=peso.getData()%></h4>
	
			<table class="table" style="border:3px solid #3680bd;position:relative;width:800px;margin-left:250px">
				<tr>
					<td>Peso</td>
					<td><input type="text" name="peso" value="<%=peso.getPeso()%>"/></td>
				</tr>
				<tr>
					<td>Data</td>
					<td><input type="text" name="data" value="<%=peso.getData()%>"/></td>
				</tr>
