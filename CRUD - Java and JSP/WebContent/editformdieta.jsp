...
<body>
	...
	<%
		...
		Dieta dieta = DietaDAO.getRegistrobyData(data);
	%>
...
<br>
<h2 style="font-weight:600;font-family:Tahoma;text-align:center;">Editar dieta</h2>
...
<br>
	...
	<form action="editDieta.jsp" method="post">
			<h4 style="font-weight:600;font-family:Tahoma;text-align:center;"><%=dieta.getData()%></h4>
	
		
			<table class="table" style="border:3px solid #3680bd;position:relative;width:800px;margin-left:250px">
				<tr>
					<td>Comida</td>
					<td><input type="text" name="comida" value="<%=dieta.getComida()%>"/></td>
				</tr>
				<tr>
					<td>Caloria</td>
					<td><input type="number" name="caloria" value="<%=dieta.getCaloria()%>"/></td>
				</tr>
				<tr>
					<td>Data</td>
					<td><input type="text" name="data" value="<%=dieta.getData()%>"/></td>
				</tr>
