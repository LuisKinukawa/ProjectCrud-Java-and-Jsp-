...
<br>
<h2 style="font-weight:600;font-family:Tahoma;text-align:center;">Cadastro de atividade</h2>
<br>
<br>

<div class="imagem">
	<img src="Health_track6.jpg" style="height:350px;width:500px;display:table-cell;float:left; position:relative;margin-left:50px">
</div>
<div class="container">
...
<div class="container" >
		...
		<br>
		<form action="addatividade.jsp" method="post">
		  <div class="mb-3">
		    <label for="pNome" class="form-label" style= "width:300px;">Nome: </label>
		    <input name="nome" type="text" class="form-control" id="pNome" aria-describedby="emailHelp" style= "width:350px;" required>
		    
		  </div>
		  <div class="mb-3">
		    <label for="ptempo" class="form-label" style= "width:300px;">Tempo em minutos: </label>
		    <input name="tempo" type="text" class="form-control" id="pTempo" aria-describedby="emailHelp" style= "width:350px;" required>
